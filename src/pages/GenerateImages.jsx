...
const GenerateImages = () => {
  const imageStyle = ['Realistic', '3D style', 'Cartoon style', 'Ghibli style', 
    'Anime style', 'Fantasy style', 'Realistic style', 'Portrait style'];
      const [selectedStyle, setSelectedStyle] = useState('Realistic');
      const [input,setInput] = useState('');
      const [pubslish,setPublish] = useState(false);
  ...
  return (
    ...
    text-slate-700'>
      {/* left col  */}
      <form onSubmit={onSubmitHandler} action="" className='w-full max-w-lg p-4 bg-white rounded-lg border
      border-gray-200'>
        ...
        <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
          {imageStyle.map((item)=>(
            ...
            cursor-pointer ${setSelectedStyle === item ? 'bg-purple-50 text-purple-700' 
